...
def parse_args():
    ...
    # parser.add_argument('--addr',
    #                     default='/media/manu/ST8000DM004-2U91/afdd/data/data_v26/data_ae/电容滤波器抑制试验+1000W阻性负载_20k.bin')
    # parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    # parser.add_argument('--db_key', default='default')
    parser.add_argument('--addr', default='/media/manu/ST8000DM004-2U91/afdd/data/data_v26/data_sorted - o/')
