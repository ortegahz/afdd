...
def parse_args():
    ...
    parser.add_argument('--addr',
                        default='/media/manu/ST8000DM004-2U91/afdd/data/data_v26/data_ae/负载抑制 - o/负载抑制性试验3（电子镇流器日光灯）+1000W阻性负载在电弧发生器后_20k.bin')
    parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    parser.add_argument('--db_key', default='default')
    # parser.add_argument('--addr', default='/media/manu/ST8000DM004-2U91/afdd/data/data_v26/data_ae_pick/')
