...
def parse_args():
    ...
    # parser.add_argument('--addr',
    #                     default='/media/manu/ST8000DM004-2U91/afdd/data/data_v37/raw_bin_20k/0090_20k.bin')
    # parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    # parser.add_argument('--db_key', default='default')
    parser.add_argument('--addr', default='/media/manu/ST8000DM004-2U91/afdd/data/data_v39/fault-arc-pick-20k/')
