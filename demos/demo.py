...
def parse_args():
    ...
    parser.add_argument('--addr',
                        default='/home/manu/mnt/ST8000DM004-2U91/afdd/data/data_v19/data_sorted/误动作/电磁炉2000 W.npy')
    parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    parser.add_argument('--db_key', default='default')
    # parser.add_argument('--addr', default='/home/manu/mnt/ST8000DM004-2U91/afdd/data/data_v20/tmp/')
