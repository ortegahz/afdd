...
def parse_args():
    ...
    # parser.add_argument('--addr', default='/media/manu/data/afdd/data/data_ v2/subsample/0627 - labled/误报警试验/')
    ...
    #                     default='/home/manu/mnt/ST8000DM004-2U91/afdd/data/data_v36/四楼配电柜拉弧.npy')
    # parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    # parser.add_argument('--db_key', default='default')
    ...
    # parser.add_argument('--addr',
    #                     default='/media/manu/ST8000DM004-2U91/afdd/data/data_v26 - duke/data_sorted - o/串联碳化 - o/串联碳化4+1_20k.bin')
    # parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    # parser.add_argument('--db_key', default='default')
    parser.add_argument('--addr', default='/media/manu/ST8000DM004-2U91/afdd/data/data_v26 - duke/data_sorted - o/负载抑制 - o/')
    ...
    # parser.add_argument('--dtr_type', default='DetectorWrapperV4H5')
    # parser.add_argument('--db_key', default=None)
