...
def parse_args():
    ...
    #                     default='/media/manu/ST8000DM004-2U91/afdd/data/data_v8/tmp/故障电弧测试数据-11.28/自主设计试验/正例/电暖+RLC各1KW.npy')
    # parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    # parser.add_argument('--db_key', default='default')
    parser.add_argument('--addr', default='/media/manu/ST8000DM004-2U91/afdd/data/data_v8/hard_case/')
