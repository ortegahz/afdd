...
def parse_args():
    ...
    #                     default='/home/manu/mnt/ST8000DM004-2U91/afdd/data/data_v15/data_sorted/自主设计实验/反例/多负载运行（定频空调+电机+电钻）.npy')
    # parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    # parser.add_argument('--db_key', default='default')
    parser.add_argument('--addr', default='/home/manu/mnt/ST8000DM004-2U91/afdd/data/data_v18/tmp/')
