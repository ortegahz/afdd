...
def parse_args():
    ...
    parser.add_argument('--addr',
                        default='/media/manu/ST8000DM004-2U91/afdd/data/data_v9/data_sorted/负载抑制性实验/负载抑制性·实验-定频空调-1-报警.npy')
    parser.add_argument('--dtr_type', default='DetectorWrapperV0')
    parser.add_argument('--db_key', default='default')
    # parser.add_argument('--addr', default='/media/manu/ST8000DM004-2U91/afdd/data/data_v9/data_sorted/负载抑制性实验/')
