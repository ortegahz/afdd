...
def svm2hdf5(args):
    ...
    x_train_aug, x_test_aug, y_train_aug, y_test_aug = \
        train_test_split(x_aug, y_aug, test_size=_test_size, random_state=_seed, stratify=y_aug)
    ...
    x_train, x_test, y_train, y_test = \
        train_test_split(x, y, test_size=_test_size, random_state=_seed, stratify=y)
    # ros = RandomOverSampler(sampling_strategy='auto')
    # x_train, y_train = ros.fit_resample(x_train, y_train)
