...
def parse_args():
    ...
    parser.add_argument('--paths_in',
                        default=[
                            ...
                            # '/media/manu/ST8000DM004-2U91/afdd/data/data_v5 - duke/故障电弧测试数据-0911/afd_data_v5_new',
                            # '/media/manu/ST8000DM004-2U91/afdd/data/data_v5 - duke/data_pick/neg/afd',
                            ...
                            # '/media/manu/ST8000DM004-2U91/afdd/data/data_v37/raw_bin_20k/afd',  # new
                            # "/media/manu/ST8000DM004-2U91/afdd/data/data_v39/fault-arc-pick-20k/afd",  # new
                        ])
    # parser.add_argument('--path_out', default='/media/manu/ST8000DM004-2U91/tmp/afd_pm_train')
    parser.add_argument('--path_out', default='/home/manu/mnt/8gpu_3090/afd_pm_train')
